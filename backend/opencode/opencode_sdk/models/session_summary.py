...
class SessionSummary(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["additions", "deletions", "files", "diffs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "files": obj.get("files"),
            "diffs": [SnapshotFileDiff.from_dict(_item) for _item in obj["diffs"]] if obj.get("diffs") is not None else None
        })
        return _obj
