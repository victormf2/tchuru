...
class IntegrationAttempt(BaseModel):
    ...
    IntegrationAttempt
    """ # noqa: E501
    attempt_id: StrictStr = Field(alias="attemptID")
    url: StrictStr
    instructions: StrictStr
    mode: StrictStr
    time: IntegrationAttemptTime
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["attemptID", "url", "instructions", "mode", "time"]

    @field_validator('mode')
    def mode_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['auto', 'code']):
            raise ValueError("must be one of enum values ('auto', 'code')")
        return value
