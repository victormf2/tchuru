...
class IntegrationOAuthMethod(BaseModel):
    """
    ...
    type: StrictStr
    label: StrictStr
    prompts: Optional[List[IntegrationOAuthMethodPromptsInner]] = None
    __properties: ClassVar[List[str]] = ["id", "type", "label", "prompts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "label": obj.get("label"),
            "prompts": [IntegrationOAuthMethodPromptsInner.from_dict(_item) for _item in obj["prompts"]] if obj.get("prompts") is not None else None
        })
        return _obj
