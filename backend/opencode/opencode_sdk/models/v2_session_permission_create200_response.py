...
class V2SessionPermissionCreate200Response(BaseModel):
    """
    V2SessionPermissionCreate200Response
    """ # noqa: E501
    data: V2SessionPermissionCreate200ResponseData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": V2SessionPermissionCreate200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
