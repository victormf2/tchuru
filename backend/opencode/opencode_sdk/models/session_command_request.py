...
class SessionCommandRequest(BaseModel):
    ...
    parts: Optional[List[SessionCommandRequestPartsInner]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["messageID", "agent", "model", "arguments", "command", "variant", "parts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parts": [SessionCommandRequestPartsInner.from_dict(_item) for _item in obj["parts"]] if obj.get("parts") is not None else None
        })
