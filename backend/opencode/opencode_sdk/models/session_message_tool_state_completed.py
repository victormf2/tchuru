...
class SessionMessageToolStateCompleted(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "input", "attachments", "content", "outputPaths", "structured", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "input": obj.get("input"),
            "attachments": [PromptFileAttachment.from_dict(_item) for _item in obj["attachments"]] if obj.get("attachments") is not None else None,
