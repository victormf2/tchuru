...
class VcsApplyError(BaseModel):
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['VcsApplyError']):
            raise ValueError("must be one of enum values ('VcsApplyError')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "data": VcsApplyErrorData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
