...
class GlobalEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["directory", "project", "workspace", "payload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payload": GlobalEventPayload.from_dict(obj["payload"]) if obj.get("payload") is not None else None
        })
