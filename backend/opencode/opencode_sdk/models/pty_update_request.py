...
class PtyUpdateRequest(BaseModel):
    ...
    size: Optional[PtyUpdateRequestSize] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["title", "size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "size": PtyUpdateRequestSize.from_dict(obj["size"]) if obj.get("size") is not None else None
        })
