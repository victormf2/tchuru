...
MESSAGE_ANY_OF_SCHEMAS = ["AssistantMessage", "UserMessage"]
...
class Message(BaseModel):
    ...
    anyof_schema_1_validator: Optional[UserMessage] = None
    # data type: AssistantMessage
    anyof_schema_2_validator: Optional[AssistantMessage] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[AssistantMessage, UserMessage]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "AssistantMessage", "UserMessage" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Message with anyOf schemas: AssistantMessage, UserMessage. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Message with anyOf schemas: AssistantMessage, UserMessage. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], AssistantMessage, UserMessage]]:
