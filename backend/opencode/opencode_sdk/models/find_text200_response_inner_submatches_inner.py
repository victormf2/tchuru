...
class FindText200ResponseInnerSubmatchesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["match", "start", "end"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindText200ResponseInnerSubmatchesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindText200ResponseInnerSubmatchesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "match": FindText200ResponseInnerPath.from_dict(obj["match"]) if obj.get("match") is not None else None,
            "start": obj.get("start"),
            "end": obj.get("end")
        })
