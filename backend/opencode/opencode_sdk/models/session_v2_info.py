...
class SessionV2Info(BaseModel):
    ...
    revert: Optional[RevertState] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "parentID", "projectID", "agent", "model", "cost", "tokens", "time", "title", "location", "subpath", "revert"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "time": SessionV2InfoTime.from_dict(obj["time"]) if obj.get("time") is not None else None,
            "title": obj.get("title"),
            "location": LocationRef.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "subpath": obj.get("subpath"),
            "revert": RevertState.from_dict(obj["revert"]) if obj.get("revert") is not None else None
        })
