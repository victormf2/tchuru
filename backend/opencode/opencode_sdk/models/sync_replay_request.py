...
class SyncReplayRequest(BaseModel):
    ...
    """ # noqa: E501
    directory: StrictStr
    events: Annotated[List[SyncReplayRequestEventsInner], Field(min_length=1)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["directory", "events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [SyncReplayRequestEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
