...
class SessionPrompt200Response(BaseModel):
    """
    SessionPrompt200Response
    """ # noqa: E501
    info: AssistantMessage
    parts: List[Part]
    __properties: ClassVar[List[str]] = ["info", "parts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "info": AssistantMessage.from_dict(obj["info"]) if obj.get("info") is not None else None,
