...
class IntegrationInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "methods", "connections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "methods": [IntegrationMethod.from_dict(_item) for _item in obj["methods"]] if obj.get("methods") is not None else None,
