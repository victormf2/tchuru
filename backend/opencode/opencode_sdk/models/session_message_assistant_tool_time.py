...
class SessionMessageAssistantToolTime(BaseModel):
    ...
    ran: Optional[Union[StrictFloat, StrictInt]] = None
    completed: Optional[Union[StrictFloat, StrictInt]] = None
    pruned: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["created", "ran", "completed", "pruned"]
