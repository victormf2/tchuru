...
class GlobalEventPayloadAnyOf76Properties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "questions": [QuestionInfo.from_dict(_item) for _item in obj["questions"]] if obj.get("questions") is not None else None,
            "tool": QuestionTool.from_dict(obj["tool"]) if obj.get("tool") is not None else None
        })
        return _obj
