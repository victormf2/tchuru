...
class V2PermissionSavedList200Response(BaseModel):
    """
    V2PermissionSavedList200Response
    """ # noqa: E501
    data: List[PermissionSavedInfo]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PermissionSavedInfo.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
