...
class ProviderAuthError(BaseModel):
    ...
    def name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ProviderAuthError']):
            raise ValueError("must be one of enum values ('ProviderAuthError')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "data": ProviderAuthErrorData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
