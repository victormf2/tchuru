...
class SessionHistory(BaseModel):
    ...
    SessionHistory
    """ # noqa: E501
    data: List[SessionDurableEvent]
    has_more: StrictBool = Field(alias="hasMore")
    __properties: ClassVar[List[str]] = ["data", "hasMore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SessionDurableEvent.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
