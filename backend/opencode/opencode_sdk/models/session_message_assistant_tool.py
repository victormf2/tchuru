...
class SessionMessageAssistantTool(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "id", "name", "provider", "state", "time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "provider": SessionMessageAssistantToolProvider.from_dict(obj["provider"]) if obj.get("provider") is not None else None,
            "state": SessionMessageAssistantToolState.from_dict(obj["state"]) if obj.get("state") is not None else None,
            "time": SessionMessageAssistantToolTime.from_dict(obj["time"]) if obj.get("time") is not None else None
        })
