...
class ExperimentalConsoleListOrgs200ResponseOrgsInner(BaseModel):
    """
    ...
    account_url: StrictStr = Field(alias="accountUrl")
    org_id: StrictStr = Field(alias="orgID")
    org_name: StrictStr = Field(alias="orgName")
    active: StrictBool
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accountID", "accountEmail", "accountUrl", "orgID", "orgName", "active"]
