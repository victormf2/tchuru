...
class McpOAuthConfig(BaseModel):
    ...
    callback_port: Optional[Annotated[int, Field(le=65535, strict=True, ge=1)]] = Field(default=None, alias="callbackPort")
    redirect_uri: Optional[StrictStr] = Field(default=None, alias="redirectUri")
    __properties: ClassVar[List[str]] = ["clientId", "clientSecret", "scope", "callbackPort", "redirectUri"]
